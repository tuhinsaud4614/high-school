  ...
  return (
    <Fragment>
      ...
      <section className="bg-cyan-100">
        <div className="md:flex md:justify-center max-w-6xl mx-auto px-4 py-3">
          <div className="relative h-[11.25rem] md:h-auto md:order-2 md:basis-1/2 bg-white rounded-xl">
